...
const PhotoEditor = (() => {
    ...
    function bindEvents() {
        ...
        document.addEventListener('keydown', e => {
            ...
            if (!isFormField && state.fullscreenIndex >= 0 && e.key === 'ArrowLeft') navigateFullscreen(-1);
            if (!isFormField && state.fullscreenIndex >= 0 && e.key === 'ArrowRight') navigateFullscreen(1);
        });
    }
